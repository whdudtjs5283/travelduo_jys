...
/**
 * Servlet implementation class productCountryListViewServlet
 */
@WebServlet("/pclist")
public class productCountryListViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public productCountryListViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> list = new ProductService().countryList(country);
