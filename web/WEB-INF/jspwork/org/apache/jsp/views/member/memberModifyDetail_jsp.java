 ...
 * Generated at: 2019-04-05 07:17:27 UTC
...
public final class memberModifyDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/header.jsp", Long.valueOf(1554445428093L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \r\n");
      out.write("   <body>\r\n");
      out.write("   <div class=\"signup-img\"><img src=\"/travelduo/resources/images/wan/회원가입에서 풍경사진1.jpg\" width= \"1519\" height= \"250\"> </div>\r\n");
...
if(loginUser!=null){ 
 ...
 if(loginUser != null && loginUser.getUserId().equals("admin")){ 
      ...
      out.write("               <div class=\"modal-dialog\">     <!--크기를 보다 작게, 화면에 맞도록 조정해주고 ,//모달창이 위에서 아래로 내려오게 뜨도록 함 클릭하면 다시위로 올라가는 듯하면서 사라짐.// 설정을 하지않으면 ,내려오지않고 맨위에 크게박혀있다. -->\r\n");
      out.write("                   <div class=\"modal-content\"> <!-- 모달창의 화면을 나타냄 . 이게 없으면 모달창이 투명하게 보인다.  -->\r\n");
      out.write("                       <div class=\"modal-header\">  <!-- 모달창 위의 헤더에 뜨는 부분  -->\r\n");
      out.write("                           <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>  <!--  data-dismiss=\"modal 은 x를 누르면 꺼지도록 함.--> \r\n");
      ...
      out.write("\r\n");
      out.write("                       </div>\r\n");
      out.write("                       <div class=\"modal-body\">\t<!-- 모달 몸통 -->\r\n");
      out.write("                           <p class=\"modal-contents\"></p> <!--모달 몸통에서의 내용이다 나중에 전역변수를 통해 , 상황에 맞는 말들을 넣어줄 것이다.  -->\r\n");
      out.write("                       </div>\r\n");
      out.write("                       <div class=\"modal-footer\">\t<!-- modal footer -->\r\n");
      out.write("                           <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">닫기</button>  <!-- 마지막에는 x와 동일한 기능을 하는 닫기버튼을 만들어준다. -->\r\n");
      out.write("                       </div>\r\n");
      ...
      out.write("\r\n");
      out.write("                 \r\n");
      out.write("        <form class=\"form-horizontal\" role=\"form\" method=\"post\"  action=\"/travelduo/mmodifydetail\">\r\n");
      out.write("     <br>\r\n");
      out.write("    <div id=\"posx\"><h3 ><strong> &nbsp;회원정보 수정</strong></h3></div>\r\n");
      out.write("        <div id=\"pos1\"> <!-- content를 좌측으로 이동시키기 위함  -->\r\n");
      out.write("         <br>\r\n");
      out.write("            <div class=\"form-group \" id=\"divId\">\r\n");
      out.write("                <label for=\"inputId\" class=\"col-lg-2 control-label \"><em style=\"color:Red\"> * </em><strong>아이디</strong></label>\r\n");
      out.write("                <div class=\"col-lg-4\" id=\"posbox\">\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"userid\" name=\"userid\" readonly value=\"");
      out.print( loginUser.getUserId());
      out.write("\" maxlength=\"20\">\r\n");
      out.write("                </div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- placeholder=\"아이디는 수정할 수 없습니다.\" -->\r\n");
      out.write("                \r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"form-group\" id=\"divName\">\r\n");
      out.write("                <label for=\"inputName\" class=\"col-lg-2 control-label\"><em style=\"color:Red\"> * </em><strong>이름</strong> </label>\r\n");
      out.write("                <div class=\"col-lg-4\" id=\"posbox\">\r\n");
      out.write("                    <input type=\"text\" class=\"form-control onlyHangul\" id=\"username\" name=\"username\"  data-rule-required=\"true\" value=\"");
      ...
      out.write("                <label for=\"inputPassword\" class=\"col-lg-2 control-label\"><em style=\"color:Red\"> * </em><strong>비밀번호</strong></label>\r\n");
      out.write("                <div class=\"col-lg-4\" id=\"posbox\"> \r\n");
      out.write("                    <input type=\"password\" class=\"form-control\" id=\"userpwd\" name=\"userpwd\" onkeyup=\"passwordCheckFunction();\" data-rule-required=\"true\" value=\"");
      ...
      out.write("                <label for=\"inputPasswordCheck\" class=\"col-lg-2 control-label\"><em style=\"color:Red\"> * </em><strong>비밀번호 확인</strong></label>\r\n");
      out.write("                <div class=\"col-lg-4\" id=\"posbox\">\r\n");
      out.write("                    <input type=\"password\" class=\"form-control\" id=\"userpwdchk\" name=\"userpwdchk\" onkeyup=\"passwordCheckFunction();\" data-rule-required=\"true\" value=\"");
      out.print( loginUser.getUserPwd() );
      out.write("\" maxlength=\"25\">\r\n");
      ...
      out.write("                <label for=\"inputEmail\" class=\"col-lg-2 control-label\"><em style=\"color:Red\"> * </em><strong>이메일 주소</strong></label>\r\n");
      out.write("                <div class=\"col-lg-4\" id=\"posbox\">\r\n");
      out.write("                    <input type=\"email\" class=\"form-control\" id=\"email\" name=\"email\" data-rule-required=\"true\" value=\"");
      out.print( loginUser.getEmail());
      out.write("\" maxlength=\"40\">\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"form-group\" id=\"divPhoneNumber\">\r\n");
      out.write("                <label for=\"inputPhoneNumber\" class=\"col-lg-2 control-label\"><em style=\"color:Red\"> * </em><strong>휴대폰 번호</strong></label>\r\n");
      out.write("                <div class=\"col-lg-4\" id=\"posbox\">\r\n");
      out.write("                    <input type=\"tel\" class=\"form-control onlyNumber\" id=\"phone\" name=\"phone\" data-rule-required=\"true\"  value=\"");
      out.print( loginUser.getPhone());
      out.write("\" maxlength=\"11\">\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"form-group\" id=\"divAge\">\r\n");
      out.write("            \t<label for=\"inputAge\" class=\"col-lg-2 control-label\"><em style=\"color:Red\"> * </em><strong>나이</strong></label>\r\n");
      out.write("            \t<div class=\"col-lg-4\" id=\"posbox\">\r\n");
      out.write("            \t\t<input type=\"text\" class=\"form-control onlyAge\" id=\"age\" name=\"age\"   data-rule-required=\"true\" value=\"");
      ...
      out.write("            </div>\r\n");
      out.write("            \r\n");
      out.write("            <div class=\"form-group\" id=\"divGender\" >\r\n");
      out.write("                <label for=\"inputGender\" class=\"col-lg-2 control-label\"><em style=\"color:Red\"> * </em><strong>성별</strong> </label>\r\n");
      out.write("                <div class=\"col-lg-4\" id=\"posbox\">\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"userid\" name=\"userid\"  readonly value=\"");
      out.print( loginUser.getGender());
      out.write("\" maxlength=\"20\">\r\n");
      out.write("                </div>\r\n");
      out.write("<!--     <br><br><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  <strong>수정되지 않는 것들에 대해 수정이 필요하다면, 고객센터로 문의하시길 바랍니다.</strong> -->\r\n");
      out.write("\t\t\t\t</div>\t\t\t\t\r\n");
      out.write("                \r\n");
      out.write("            \t</div>\t\t\t      \r\n");
      out.write("             \r\n");
      ...
      out.write("\t\t\t<a href=\"/travelduo/index.jsp\" ><button type=\"button\" class=\"btn btn-danger\">취소\t</button></a>\r\n");
      out.write("\t  \t   <input type=\"submit\" value=\"수정하기\" class=\"btn btn btn-primary disabled float-right\">\r\n");
      out.write("       \t\r\n");
      out.write("            \r\n");
      out.write("             \r\n");
      out.write("        </form>\r\n");
