 ...
 * Generated at: 2019-04-05 07:26:51 UTC
...
public final class qnaDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/qna/../common/footer.jsp", Long.valueOf(1554293034000L));
    _jspx_dependants.put("/views/qna/../common/header.jsp", Long.valueOf(1554445428093L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	/* Member loginUser = (Member)session.getAttribute("loginUser"); */
      ...
      out.write("\tlocation.href = \"/travelduo/views/qna/qnaReplyForm.jsp?qnum=");
      ...
      out.write("\tlocation.href = \"/travelduo/qupview?no=");
      out.print( qna.getQNANo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\";\r\n");
      ...
      out.write("\tlocation.href = \"/travelduo/qdel?no=");
      out.print( qna.getQNANo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\";\r\n");
      out.write("}\r\n");
      out.write("function deleteQNAReply(){\r\n");
      out.write("\tlocation.href = \"/travelduo/qdelre?no=");
      out.print( qna.getQNANo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\";\r\n");
...
if(loginUser!=null){ 
 ...
 if(loginUser != null && loginUser.getUserId().equals("admin")){ 
      ...
      out.write("\t\t<h2 class=\"qna_head\">");
      out.print( qna.getQNANo() );
      out.write(" 번 QNA 상세보기</h2>\r\n");
      out.write("\t\t<hr>\r\n");
      out.write("\t</div> \r\n");
      out.write("\t\t<form class=\"form-horizontal\" action=\"\" method=\"post\">\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"title\" class=\"col-md-12 col-md-offset-1\">제목 &nbsp; &nbsp; &nbsp;");
      out.print( qna.getQNATitle() );
      out.write("</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"writer\" class=\"col-md-12 col-md-offset-1\">작성자 &nbsp; &nbsp; &nbsp; ");
      out.print( qna.getQNAWriter() );
      out.write("</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"content\" class=\"col-md-6 col-md-offset-1\">내용\r\n");
      out.write("\t\t\t\t<textarea class=\"form-control\" rows=\"5\" id=\"content\" name=\"content\" readonly>");
 ...
 if(loginUser != null && loginUser.getUserId().equals("admin") && qna.getQNAReply() == 0){ 
      out.write("\r\n");
      out.write("\t\t\t<input type=\"button\" onclick=\"replyForm();\" class=\"btn btn-primary btn-sm\" value=\"답글달기\">&nbsp;\r\n");
      out.write("\t\t");
 ...
 if(loginUser.getUserId().equals(qna.getQNAWriter())){ 
      out.write("\r\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"moveUpdatePage();\" class=\"btn btn-success btn-sm\">수정하기</button> \t\t\t\t\r\n");
      out.write("\t\t\t\t");
 }if(loginUser != null && qna.getQNAReply()==0 && (loginUser.getUserId().equals(qna.getQNAWriter()) || loginUser.getUserId().equals("admin"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"deleteQNA();\" class=\"btn btn-danger btn-sm\">삭제하기</button>\r\n");
      out.write("\t\t\t\t");
 }if(loginUser != null && qna.getQNAReply()==1 && (loginUser.getUserId().equals(qna.getQNAWriter()))) { 
      out.write(" \r\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"deleteQNAReply();\" class=\"btn btn-danger btn-sm\">답글삭제</button>\r\n");
      out.write("\t\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t<a type=\"button\" class=\"btn btn-info btn-sm\" href=\"/travelduo/qlist\">목록</a> \r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t</div>\t\r\n");
