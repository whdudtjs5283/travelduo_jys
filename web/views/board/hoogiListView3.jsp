...
function viewProfile(){
	...
	var url ="/travelduo/views/board/Profile.jsp"
...
<tr>
	...
	아이디로 게시글 검색</a></small></li>
	<li> <small><form class="btn btn-primary btn-sm" onclick="viewProfile()">프로필보기
...
<center>
	<tr>
        <td colspan="2">
   <input align="center" type="button" class="btn btn-primary" value="목록 " onclick=""/>
