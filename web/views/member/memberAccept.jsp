...
<body>
	<div class="container">
		...
		<form class="form-horizontal" role="form" method="post"
			action="memberSignUp.jsp">
			<h3 style="border-bottom: 1px solid #ccc" width="20%">
				<strong>회원가입</strong>
			</h3>
			<div id="pos1">
				...
				<label for="provision">&emsp;
					<h5>
						<em style="color: Red">* &nbsp;</em> 여행가듀오 서비스 약관 동의
					</h5>
				</label><br>
...
제 1 장 총 칙
제 1 조 목적
본 약관은 서비스 이용자가 주식회사 여행가듀오(이하 “travelduo”라 합니다)가 제공하는 온라인상의 인터넷 서비스(이하 “서비스”라고 하며, 접속 가능한 유∙무선 단말기의 종류와는 상관없이 이용 가능한 “회사”가 제공하는 모든 “서비스”를 의미합니다. 이하 같습니다)에 회원으로 가입하고 이를 이용함에 있어 회사와 회원(본 약관에 동의하고 회원등록을 완료한 서비스 이용자를 말합니다. 이하 “회원”이라고 합니다)의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.
...
본 약관은 2016년 10월 7일부터 적용됩니다. 단, 본 약관의 공지 시점으로부터 적용일 전일까지 기간 동안에 가입한 신규회원에 대해서는 회원 가입시부터 본 약관이 적용됩니다.
						...
						<div class="radio">
							<br>&emsp; <label> <input type="radio"
								id="provisionYn" name="provisionYn" value="Y"
								autofocus="autofocus"> 동의합니다.
							</label>
						</div>
						<div class="radio">
							&emsp; <label> <input type="radio" id="provisionYn"
								name="provisionYn" value="N" checked> 동의하지 않습니다.
							</label>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="memberInfo">&emsp;
						<h5>
							<em style="color: Red"> * &nbsp;</em> 여행가듀오 개인정보 수집 및 이용 동의
						</h5>
					</label><br>
					<div class="col-lg-10" id="memberInfo">
						<textarea class="form-control" rows="8" style="resize: none"
							readonly>
(주)여행가듀오는 아래의 목적으로 개인정보를 수집 및 이용하며, 회원의 개인정보를 안전하게 취급하는데 최선을 다합니다.
1. 수집목적
...
더 자세한 내용에 대해서는 개인정보처리방침을 참고하시기 바랍니다.
						...
						<div class="radio">
							<br>&emsp; <label> <input type="radio"
								id="memberInfoYn" name="memberInfoYn" value="Y"> 동의합니다.
							</label>
						</div>
						<div class="radio">
							&emsp; <label> <input type="radio" id="memberInfoYn"
