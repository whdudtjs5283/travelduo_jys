...
<%
 ...
 String findPwdMember = (String)session.getAttribute("findPwdMember");
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 content-body">
				...
				<h3>아이디와 핸드폰 번호로 비밀번호 찾기</h3>
				<p>
					입력된 아이디와 핸드폰 번호에 대한 비밀번호 값입니다.<br />
				</p>
				<div id="pos1">
					<div class="message info">
						...
						<h5>
							회원님의 비밀번호는 <strong><%= findPwdMember  %></strong> 입니다.
						</h5>
					</div>
				</div>
				<br>
