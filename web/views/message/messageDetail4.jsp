<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    java.sql.Date, java.util.*, java.text.SimpleDateFormat" %>
 <%
 	int currentPage = 
 	...
 	Date time = Message.getMessageDate();
...
<img src="/travelduo/file/matchinfo/<%= matchinfo.getMatchPhoto() %>" width="600" height="500" class="img-thumbnail">
 			...
 			&nbsp;&nbsp;&nbsp;
 			<a onclick="sendmessage()">답장하기
					<input type="hidden" name="address" class="btn btn-outline-secondary"
